...
function LoadingState() {
  return (
    <div className="min-h-[40vh] flex flex-col items-center justify-center">
      ...
      <p className="text-gray-600 font-medium">Loading your hotels...</p>
    </div>
  );
}

export default function MyHotalsPage() {
      ...
      <div className="min-h-screen bg-linear-to-b from-blue-50 to-gray-50 pt-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-10">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 text-center">
            ...
            <p className="text-gray-600 mt-2">Please log in to view your hotels.</p>
            <Link
              href="/auth/login"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
        ...
        >
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 sm:gap-6">
            <div>
              ...
              <p className="mt-2 text-md text-gray-600 max-w-2xl">
                Manage the properties you’ve added and keep them up to date.
              </p>
            </div>
            <Link
              href="/add-hotel"
          ...
          <div className="mt-6 inline-flex items-center gap-3 px-5 py-3 bg-linear-to-r from-blue-50 to-indigo-50 rounded-xl shadow-inner text-sm text-gray-800 font-semibold border border-blue-100">
            ...
            <span className="text-gray-700">{listings.length === 1 ? "property listed" : "properties listed"}</span>
        ...
        {loading ? (
          ...
          >
            <div className="flex flex-col items-center justify-center gap-4">
              <h3 className="text-xl font-semibold text-gray-800">No hotels yet</h3>
              <p className="text-gray-600 max-w-md">
                You haven’t listed any properties. Add your first hotel to get started.
              </p>
              <Link
                href="/add-hotel"
